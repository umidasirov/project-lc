...
function App() {
  ...
  return (
    <div className="App">
     ...
     data-aos-duration="3000">
        <Titles components={base.instructors.map((e)=>(<OurInstructor name={e.name} students={e.students} course={e.course} link={e.link} img={e.img}/>))} title='OUR INSTRUCTOR' titleOf="Professional" titleOfmore=" instructors"/>
      </div>
    </div>
  );
}
